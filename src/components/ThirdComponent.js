        ...
        <div className="component third-component">
            <div className="container-fluid">
                ...
                <div className="col-lg-12 job-wrap">
                    ...
                    A Digitalspark consultant works with solving complex business critical challenges
                     which demand excellence in innovative thinking and teamwork.<br></br>
                     You will be working in an exciting international work environment and have 
                ...
                <p className="job-desc">We are looking for a Head of Sales with an established record of sales.
                 In this role, you will oversee sales and developing our client relations.
                  We need someone with the ability to see new opportunities, who is creative in their approach towards new clients and new tasks,
                ...
                <p className="job-desc">We are now looking for a new team member, 
                with responsibilities to find, attract and match the best consultants 
                to our customers. The work is about taking overall responsibility to ensure the 
                high quality delivery process. You should therefore be driven by doing business and having many 
